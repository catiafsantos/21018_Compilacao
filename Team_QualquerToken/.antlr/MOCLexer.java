...
public class MOCLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"INT", "DOUBLE", "VOID", "MAIN", "READ", "READC", "READS", "WRITE", "WRITEC", 
			"WRITEV", "WRITES", "IF", "ELSE", "WHILE", "FOR", "MAIS", "MENOS", "MULT", 
			"DIV", "MODULO", "MENOR", "MENORIGUAL", "MAIOR", "MAIORIGUAL", "IGUAL", 
			"DIFERENTE", "E_LOGICO", "OU_LOGICO", "NAO", "ATRIBUICAO", "VIRGULA", 
